            ...
            if (ret.code === 0) {
                ...
                layer.msg('注册成功', {
                    ...
                    time: 1500,
                        ...
                        location.href = T.baseUrl + '/user/registerSuccess.html';
                    }
                });
            } else {
                $(self).val('确认注册');
