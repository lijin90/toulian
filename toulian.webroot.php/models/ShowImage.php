...
/**
 * This is the model class for table "t_show_image".
 *
 * The followings are the available columns in table 't_show_image':
 * @property string $ID
 ...
 */
class ShowImage extends CActiveRecord {
    ...
    public function rules() {
        ...
        return array(
            ...
            array('ImageName, Description, Path', 'length', 'max' => 255),
            // The following rule is used by search().
            // @todo Please remove those attributes that should not be searched.
            array('ID, DeptID, ImageName, Description, Path, IsShow, SortNo, CreateTime', 'safe', 'on' => 'search'),
        );
    }
     ...
     * @return ShowImage the static model class
     */
     ...
     */
    public static function getShowImages($deptId, $isShow = null) {
        $query = Yii::app()
                ->getDb()
                ->createCommand()
                ->select('*')
