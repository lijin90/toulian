 ...
 */
class EnterpriseworldController extends Controller {

    public function actionIndex() {
        $this->setPageTitle(Yii::app()->name . ' - 企业天地');
    ...
    public function actionDetail() {
        ...
        if (empty($id)) {
            $this->redirect(Yii::app()->createUrl('enterpriseworld/index'));
        }
        $data = Department::model()->getDepart($id);
        if (!$data) {
            $this->redirect(Yii::app()->createUrl('enterpriseworld/index'));
        }
        $this->setPageTitle(Yii::app()->name . ' - 企业天地 - ' . $data['DeptName']);
        $this->breadcrumbs = array(
            array('name' => '首页', 'url' => Yii::app()->getHomeUrl()),
            array('name' => '企业天地', 'url' => Yii::app()->createUrl('enterpriseworld/index')),
